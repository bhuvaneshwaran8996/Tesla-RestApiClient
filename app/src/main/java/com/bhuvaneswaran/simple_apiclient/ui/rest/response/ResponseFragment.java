...
import com.bhuvaneswaran.simple_apiclient.databinding.FragmentResponseBinding;
...
public class ResponseFragment extends BaseFragment<FragmentResponseBinding, com.bhuvaneswaran.simple_apiclient.ui.rest.response.ResponseViewModel> implements ResponseNavigator{
    ...
    @Inject
    @com.bhuvaneswaran.simple_apiclient.di.qualifier.bodyResponse
    String bodyResponse;
    @Inject
    @com.bhuvaneswaran.simple_apiclient.di.qualifier.headerResponse
