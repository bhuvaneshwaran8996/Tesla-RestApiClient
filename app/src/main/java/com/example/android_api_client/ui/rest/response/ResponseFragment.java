...
import com.example.android_api_client.databinding.FragmentResponseBinding;
...
public class ResponseFragment extends BaseFragment<FragmentResponseBinding,ResponseViewModel> implements ResponseNavigator{
    ...
    @Inject
    @com.example.android_api_client.di.qualifier.bodyResponse
    String bodyResponse;
    @Inject
    @com.example.android_api_client.di.qualifier.headerResponse
